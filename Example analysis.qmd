...
ggplot(data=data) +
  ...
  labs(title = "Figure 1: Distribution of Participant Age at survey ", 
...
ggplot(data = data) + 
  ...
  labs(title = "Figure 2: Distribution of Menopausal Age and Livebirths by Race/Ethnicity",
       x = "Menopausal Age", y = "Number of Livebirths",caption = "Created by Yinging Yu") 
```
...
ggplot(data = data) + 
  ...
  labs(title = "Figure 3: Distribution of BMI and Menopausal Age", x = "BMI", 
       y = "Menopausal Age",caption = "Created by Yinging Yu") 
```
